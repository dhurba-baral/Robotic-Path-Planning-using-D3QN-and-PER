...
class MazeEnvironment:
    ...
    def step(self, action):
        ...
        # In dynamic mode, move exactly one wall at every step
        if self.dynamic and self.steps % 2 == 0:
            self._move_one_wall()
